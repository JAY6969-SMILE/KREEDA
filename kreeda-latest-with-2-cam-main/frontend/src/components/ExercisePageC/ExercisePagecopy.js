    ...
    let t1 = gsap.timeline ({
      ...
      onComplete: function () { 
        ...
        if (pointer.current === 0 && exerlist[pointer.current] === 'Setup') {  
          document.getElementsByClassName("vidAndCanvaContainer")[0].style.position = 'relative'; 
          document.getElementsByClassName("vidAndCanvaContainer")[1].style.position = 'relative'; 
          // console.log("xy is :",xy);
          console.log(pointer.current,exerlist );
          
        } else { 
          document.getElementsByClassName("vidAndCanvaContainer")[0].style.position='absolute';
          document.getElementsByClassName("vidAndCanvaContainer")[1].style.position ='absolute'; 
